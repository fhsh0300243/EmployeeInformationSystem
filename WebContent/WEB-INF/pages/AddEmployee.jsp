	...
	<div class="div1">
		...
		<form action="<c:url value="/AddEmployee.action"/>" method="POST"
			...
			<table class="st1">
				<tr>
					<td>帳號：</td>
					<td><input type="text" id="account1" name="userName" size="30"
						value="${inputmsg.username}" autocomplete="off"></td>
				...
				<tr>
					<td>Email：</td>
					<td><input type="email" name="email" value="${inputmsg.email}" size="30" autocomplete="off"></td>
