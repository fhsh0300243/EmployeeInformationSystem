					...
					<div class="panel-body">
						...
						<div class="introduce_wrap mt60">
							...
							<div class="commentKecheng_wrap mt60">
								...
								<br/>
								<br/>
								<img src="images/mood.gif" width="20%" style="position:relative; left:0px;">
								<br/>
								<br/>
								<p>
								<font size="5">
...
<script src="/js/amazeui.min.js"></script>
    ...
    <div class="CanNotRightDownDiv">
		<img class="CanNotRightDown" src="images/CompanyLogo.png" style="position:relative; left:-250px; top:20px">
	</div>
